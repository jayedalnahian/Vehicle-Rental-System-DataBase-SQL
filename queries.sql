...
create table users (
    ...
    u_role varchar(20) check (
        u_role in ('admin', 'customer')
    ) not null,
...
VALUES
    -- Booking 1
    (
        '86d08296-abf2-4a19-945c-d505c1b32958',
        'fc4d2c18-d666-465f-b9f8-fb69772e9558',
        '2025-12-01',
        '2025-12-05',
        'completed',
        250.00
    ...
    -- Booking 2
    (
        '46bc7fea-0ae9-4af7-9c24-781ccfe49b45',
        '6858d8fb-08b5-4c99-9cb8-648bbc354804',
        '2025-12-03',
        '2025-12-06',
        'confirmed',
        165.00
    ...
    -- Booking 3
    (
        '0b98b8c6-239d-49fd-84c8-dd37a630c4eb',
        '89031643-dbb7-4688-b91a-c7a3126c32ea',
        '2025-12-05',
        '2025-12-07',
        'cancelled',
        80.00
    ...
    -- Booking 4
    (
        '2e699aa8-114d-4b7f-8cd7-5dd6029b8049',
        '36599afb-9fe4-41e1-aba0-f0c112f81481',
        '2025-12-02',
        '2025-12-04',
        'confirmed',
        160.00
    ...
    -- Booking 5
    (
        'af1472d8-235d-42f7-bfce-a1f81e577415',
        'ae67f043-7ffe-4203-8716-704376dfcd89',
        '2025-12-06',
        '2025-12-10',
        'pending',
        375.00
    ...
    -- Booking 6
    (
        '6372eae7-4133-4720-b190-4d72522cc41e',
        '212d0f10-3bf3-483f-afcc-fdd2e122866d',
        '2025-12-01',
        '2025-12-03',
        'completed',
        180.00
    ...
    -- Booking 7
    (
        'f19c9cf4-9216-4579-b31b-0665a0546330',
        '16966c76-9f64-4e2e-b1fb-943c635ff34b',
        '2025-12-08',
        '2025-12-12',
        'confirmed',
        380.00
...
create trigger trg_update_vehicle_status after
insert
    or
...
-- 'SUV', 'Pickup', 'Sedan', 'Hatchback', 'Coupe'

select * from vehicles where v_type = 'SUV';
